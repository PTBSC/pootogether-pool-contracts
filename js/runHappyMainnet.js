...
async function main() {
  ...
  let multipleWinnersConfig = {
    rngService: '0xeDd591436169297c2B9A11ED55f71A33F4BcC36c',
  ...
  let prizePoolConfig = {
    cToken: '0xe9e7cea3dedca5984780bafc599bd69add087d56', //vBUSD TESTNET
  ...
  console.log(prizePoolStrategy)
  // TokenFaucet testing
  console.log('starting faucet creation')

  const dripRate = ethers.utils.parseEther('0.08680555556')
  ...
  // Create token faucet
  tx = await tokenFaucetProxyFactory.create(prizePool, await vbusdPrizeStrategy.ticket(), dripRate)
  ...
  tx = await pooToken.transfer(vbusdTokenFaucet, allocatedToken, overrides) // pootoken
